...
export const ALL_PRODUCTS: Product[] = [
  // ─── PC ────────────────────────────────────────────────────
  {
    ...
    tagline: 'An external Free Fire PC panel with multiple targeting modes and guided setup.',
    badge: 'BEST PANEL',
    images: [
  ...
  // ─── Mobile ────────────────────────────────────────────────
  {
    ...
    tagline: 'A non-root mobile panel with a focused feature set for supported Android devices.',
    badge: 'Non-Root',
    images: [
  ...
  // ─── iOS ───────────────────────────────────────────────────
  {
    ...
    tagline: 'An iPhone and iPad panel with no-jailbreak setup guidance for supported versions.',
    badge: 'No Jailbreak',
    images: [
    ...
    support: [
      ...
      'Confirm Current Compatibility Before Ordering',
    ],
